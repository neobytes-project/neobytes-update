...
Only requiring some minor changes is neobytes.cpp.
...
Changes to neobytes.cpp
----------------------
neobytes.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
